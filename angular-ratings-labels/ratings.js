...
(function() {
  ...
  app.directive("angularRatings", function() {
    return {
      ...
      replace: true,
      transclude: true,
      template: '<span class="ratings-wrapper"><ol class="ratings">' + '<li ng-class="{active:model>0,over:over>0}">1</li>' + '<li ng-class="{active:model>1,over:over>1}">2</li>' + '<li ng-class="{active:model>2,over:over>2}">3</li>' + '<li ng-class="{active:model>3,over:over>3}">4</li>' + '<li ng-class="{active:model>4,over:over>4}">5</li>' + '</ol></span>',
      controller: [
